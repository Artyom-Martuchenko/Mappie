    ...
    <div className="big_cards_main">
      ...
      <div id="big_cards_group">
        ...
        <div id="big_cards_group_buttons">
          {active ? (
            <button className="button_search_disactive" id="button_save_activate" onClick={clickHandler}>
            ...
            <button className="button_search_disactive" id="button_save_disactivate" onClick={clickHandler}>
